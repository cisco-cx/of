...
func TestLogError(t *testing.T) {
	...
	require.Contains(t, string(buf.Bytes()), fmt.Sprintf("level=%s msg=\"%s\" file=\"%s:%d\"", "error", "This is an error message.", "testing.go", 909))
}
...
func TestLogWarningf(t *testing.T) {
	...
	// "time="2019-09-10T10:51:43+05:30" level=error msg="This is an error message." file="log_test.go:43"
	require.Contains(t, string(buf.Bytes()), fmt.Sprintf("level=%s msg=\"%s\" file=\"%s:%d\"", "warning", "This is an warning.", "testing.go", 909))
}
...
func TestWithField(t *testing.T) {
	...
	require.Contains(t, string(buf.Bytes()), fmt.Sprintf("level=%s msg=\"%s\" file=\"%s:%d\" key=value key2=value2", "error", "Errors with custom field.", "testing.go", 909))
	log.WithField("key3", "value3").Errorf("Errors with custom field again.")
	// time="2019-09-10T11:17:19+05:30" level=error msg="Errors with custom field." file="log_test.go:63" key=value key2=value2
	require.Contains(t, string(buf.Bytes()), fmt.Sprintf("level=%s msg=\"%s\" file=\"%s:%d\" key3=value3", "error", "Errors with custom field again.", "testing.go", 909))
}
...
func TestAutoClearFieldsDisabled(t *testing.T) {
	...
	log.WithField("key3", "value3").Errorf("Errors with custom field again.")
	require.Contains(t, string(buf.Bytes()), fmt.Sprintf("level=%s msg=\"%s\" file=\"%s:%d\" key=value key2=value2 key3=value3", "error", "Errors with custom field again.", "testing.go", 909))
}
...
func TestWithFields(t *testing.T) {
	...
	require.Contains(t, string(buf.Bytes()), fmt.Sprintf("level=%s msg=\"%s\" file=\"%s:%d\" key1=val1 key2=val2 key3=val3", "debug", "Errors with custom fields.", "testing.go", 909))
}
...
func TestWithDebugEnabled(t *testing.T) {
	...
	require.Contains(t, string(buf.Bytes()), fmt.Sprintf("level=%s msg=\"%s\" file=\"%s:%d\"", "debug", "Debug log enabled.", "testing.go", 909))
}
...
func TestLogInfo(t *testing.T) {
	...
	require.Contains(t, string(buf.Bytes()), fmt.Sprintf("level=%s msg=\"%s\" file=\"%s:%d\"", "info", msg, "testing.go", 909))
}
...
func TestLogTrace(t *testing.T) {
	...
	log.Tracef(msg)
	// "time="2019-09-10T10:51:43+05:30" level=info msg="This is an info message." file="log_test.go:118"
	require.Contains(t, string(buf.Bytes()), fmt.Sprintf("level=%s msg=\"%s\" file=\"%s:%d\"", "trace", msg, "testing.go", 909))
}
...
func TestLogDebug(t *testing.T) {
	...
	log.Debugf(msg)
	// "time="2019-09-10T10:51:43+05:30" level=info msg="This is an info message." file="log_test.go:118"
	require.Contains(t, string(buf.Bytes()), fmt.Sprintf("level=%s msg=\"%s\" file=\"%s:%d\"", "debug", msg, "testing.go", 909))
}
...
func TestFatalF(t *testing.T) {
	...
	require.Contains(t, string(output), fmt.Sprintf("level=%s msg=\"%s\" file=\"%s:%d\"", "fatal", msg, "testing.go", 909))
}
