...
def format_yaml(faults):
    ...
    for fault_name in faults:
        ...
        for fault in faults[fault_name]:
            ...
            # drop the ones in the DROPPED_FAULTS, keep everything else
            if fault_code in DROPPED_FAULTS:
...
def format_csv(faults):
    ...
    for fault_name in faults:
        ...
        if fault_code not in DROPPED_FAULTS:
            ...
            row = {
                ...
                "Clear Trap": "Yes",
                "Software Release": "-",
                "Description": "APIC: " + most_severe["explanation"],
                "Impact": "-",
                "Suggestion": "-",
                "Generic Alarm Name": "-",
                "Probable Cause": "-",
